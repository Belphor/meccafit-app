-- FENYXIA · HOTFIX — obter_calor_muscular_atleta · STABLE → VOLATILE (INSERT em evolucao_membro_estase)
-- Idempotente · Aplicar após 20260530121000_fix_obter_calor_ambiguous.sql
