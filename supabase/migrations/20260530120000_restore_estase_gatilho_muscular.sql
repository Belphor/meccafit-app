-- FENYXIA · Estase muscular VIP — gatilho is_frozen via historico_treinos_personais
-- Requer: dual-track + migration Evolução Aba 3
-- Clientes sem vínculo Personal → is_frozen sempre false (sistema geral)
...
COMMENT ON FUNCTION public.obter_calor_muscular_atleta(uuid) IS
  'Aba Evolução — 4 membros · estase VIP se membro ausente da ficha personal · geral se sem bond.';
