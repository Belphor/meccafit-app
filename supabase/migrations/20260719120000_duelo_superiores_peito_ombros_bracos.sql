-- Duelos SUPERIORES: peito + ombros + braços (alinha aos treinos da semana).
...
COMMENT ON FUNCTION public.comunidade_grupo_elegivel_duelo(public.tipo_confronto_duelo, public.grupo_muscular_evolucao) IS
  'SUPERIORES → PEITO+OMBROS+BRACOS · INFERIORES → PERNAS · MIDAS.';
...
COMMENT ON VIEW public.view_rankings_vtc_faixa_superiores IS
  'Top 10 VTC mensal · faixa Superiores (PEITO+OMBROS+BRACOS) · #1 vira Rei das Chamas no fecho.';
