-- Fix: get_muscular_evolution faz INSERT em planos_atletas — não pode ser STABLE (read-only)
-- Idempotente · Aplicar após 20260619100000_fix_ignicao_index_window.sql
...
COMMENT ON FUNCTION public.get_muscular_evolution() IS
  'MIDAS · Evolução muscular JSONB · ignição 30d inclusiva · VOLATILE (INSERT planos_atletas).';
