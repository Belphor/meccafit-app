...
export type DashboardTabId = "treino" | "evolucao" | "mural";
...
const TABS: { id: DashboardTabId; label: string; aba: string }[] = [
  ...
  { id: "mural", label: "Mural", aba: "Aba 6" },
];

export function DashboardTabNav({ activeTab, muralCount, onTabChange }: DashboardTabNavProps) {
  return (
    <nav
