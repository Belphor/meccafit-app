...
export const FORJA_VTC_PHASE_REFERENCE: ForjaVtcPhaseReferenceRow[] = [
  {
    ...
    description: "Início da jornada, com volume baixo nos últimos 30 dias.",
  },
  {
    tier: 2,
    label: PHASE_TIER_LABELS[2],
    vtcRangeLabel: "5.000 – 19.999 kg",
    description: "Consistência inicial. O cliente treina com regularidade.",
  },
  {
    tier: 3,
    label: PHASE_TIER_LABELS[3],
    vtcRangeLabel: "20.000 – 49.999 kg",
    description: "Volume sólido, com evolução visível no mês.",
  },
  {
    tier: 4,
    label: PHASE_TIER_LABELS[4],
    vtcRangeLabel: "50.000 – 99.999 kg",
    description: "Alta dedicação, com treinos frequentes e pesados.",
  },
  {
    tier: 5,
    label: PHASE_TIER_LABELS[5],
    vtcRangeLabel: "100.000 kg ou mais",
    description: "Elite de volume, com máxima intensidade no período.",
  },
];
